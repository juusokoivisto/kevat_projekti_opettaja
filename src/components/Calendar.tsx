      ...
      try {
        ...
        const mappedEvents = tapahtumat.map(e => {
          ...
          if (e.opettaja) {
            ...
            backgroundColor: e.opettaja && (e.opettaja as any).vari ? (e.opettaja as any).vari : (darkMode ? '#1976d2' : '#3788d8'),
            borderColor: e.opettaja && (e.opettaja as any).vari ? (e.opettaja as any).vari : undefined,
            extendedProps: {
              ryhmaId: e.ryhmaId,
